...
#%%
dataset = load_real_samples('G:/vh_ndvi_training.npz')
...
gan_model_unet = define_gan(g_model_unet, d_model, (256,256,1))
train(d_model, g_model_unet, gan_model_unet, dataset)
#%%
